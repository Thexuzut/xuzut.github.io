...
document.write("<h id=r505>"+hariarray[hari]+","+tanggal+" "+bulanarray[bulan]+" "+tahun+("</h>"))
var r505=document.getElementById("r505"); //get span to apply rainbow
var myRainbowSpan=new RainbowSpan(r505, 0, 360, 255, 50, 18);
